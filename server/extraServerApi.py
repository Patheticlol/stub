    ...
    class __ServerSystem(object):
        ...
        class _Component(object):
            def __init__(self):
                ...
                self.bypassArmor = None
                self.dimensionId = None
                self.mirrorDimension = None
                self.gameType = None
                ...
                self.disableContainers = None
                self.disableDropItem = None
                self.gameRulesInfo = None
                self.time = None
                self.isRaining = None
                self.rainingLevel = None
                self.rainingTime = None
                self.isLightning = None
                self.lightningLevel = None
                ...
                self.isGlobal = None
                self.needPlay = None
                self.registerItems = None
                self.addItems = None
                self.addModItems = None
                self.addItemDicts = None
                self.offHandItem = None
                self.carriedItem = None
                self.invItemNum = None
                self.invItemExchange = None
                self.registerRecipes = None
                self.registerBlockPatterns = None
                self.block = None
                self.addItem = None
                self.chestItemNum = None
                self.modelName = None
                self.texture = None
                self.useSkin = None
                self.command = None
                ...
                self.minCount = None
                self.maxCount = None
                self.minBrightness = None
                self.maxBrightness = None
                self.minHeight = None
                self.maxHeight = None
                self.environment = None
                self.unitBubbleAirSupply = None
                self.currentAirSupply = None
                self.maxAirSupply = None
                self.isConsumingAirSupply = None
                self.entityId = None
                self.control = None
                self.right = None
                self.showHI = None
...
def OpenPlayerCritBox(playerId):
    pass


def ClosePlayerCritBox(playerId):
    pass
...
def CreateComponent(levelId, nameSpace, name):
    return GetServerSystemCls()._Component()
