...
def GetUI(myModName, key):
    class __uiNode(object):
        ...
        def SetUiModel(self, componentPath, modelName):
            pass
    return __uiNode
...
def StartNavTo(pos, sfxPath, callback, sfxIntl=2, sfxMaxNum=16, sfxScale=(0.5, 0.5), maxIteration=800, isSwimmer=False):
    pass
